...
const ChatBox = () => {
  ...
  return user && (
    <div className='flex flex-col h-screen'>
      <div className='flex gap-2 items-center p-2 md:px-10 xl:pl-42 bg-gradient-to-r
      ...
      <div className='px-5 md:px-10 h-full overflow-y-scroll'>
        <div className='space-y-4 max-w-4xl mx-auto bg-white shadow p-2 rounded-lg'>
          {
        ...
        <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto
         border border-gray-200 shadow rounded-full mb-5'>
          ...
          <label htmlFor="image">
            {
              image ?
                ...
                : <ImageIcon className='size-7 text-gray-600 cursor-pointer' />
            }
          ...
          <button onClick={sendMessage}
            ...
            hover:from-indigo-600 hover:to-purple-700 active:scale-95 p-2 rounded-full text-white cursor-pointer'>
