  ...
  return (
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4'>
      ...
      <div className='flex gap-4 pb-5'>
        {/* Add Story card */}
        <div onClick={() => setShowModal(true)} className='rounded-lg shadow-sm min-w-30 max-h-40 aspect-[3/4] cursor-pointer hover:shadow-lg
        transition-all duration-200 border-2 border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white'>
          <div className='h-full flex flex-col items-center justify-center p-4'>
            ...
            <p className='text-sm font-medium text-slate-700 text-center'>Đăng tin</p>
          </div>
        </div>
        ...
        {/* Story card */}
        {
          stories.map((story, index) => (
            ...
            hover:from-indigo-700 hover:to-purple-800 active:scale-95`}>
              ...
              z-10 rounded-full ring ring-gay-100 shadow' />
